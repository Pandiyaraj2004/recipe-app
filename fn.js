    ...
    if (input.files.length > 0) {
        ...
        .then(data => {
            if (data.data && data.data.url) {
                ...
                outputDiv.innerHTML = `<p>Image uploaded successfully!</p><p>Image URL: <a href="https://yandex.com/images/touch/search?rpt=imageview&url=${imageUrl}safe=off" target="_blank">https://yandex.com/images/touch/search?rpt=imageview&url=${imageUrl}safe=off</a></p>`;
            } else {
